...
public class SpecialInervalTreeMap {
    /***
     *
     *  This is input
     * 3
    ...
    static long[] Special_Interval(int N, int[][] special, int Q, int[][] non_special){
        ...
        long[] l = new long[Q];
        TreeMap<Integer,int[][]> specialStart;
        TreeMap<Integer,int[][]> specialEnd;
        TreeMap<Integer,int[][]> nonSpecialStart;
        TreeMap<Integer,int[][]> nonSpecialEnd;

        //specialStart.lowerKey()
